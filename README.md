...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/jamako/HXK) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为`bfa6a5b6-3f0f-430b-853a-481c56de1235`，WS路径为$UUID-[vmess|vless|trojan|ss|socks]格式

### 客户端
* **务必替换所有的`xxx.herokuapp.com`为heroku分配的项目域名**  
* **务必替换所有的`bfa6a5b6-3f0f-430b-853a-481c56de1235`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 端口：443
* 默认UUID：bfa6a5b6-3f0f-430b-853a-481c56de1235
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/bfa6a5b6-3f0f-430b-853a-481c56de1235-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "bfa6a5b6-3f0f-430b-853a-481c56de1235"
    ],
    "websocket": {
        "enabled": true,
        "path": "/bfa6a5b6-3f0f-430b-853a-481c56de1235-trojan",
...
* 端口: 443
* 密码：bfa6a5b6-3f0f-430b-853a-481c56de1235
* 加密：chacha20-ietf-poly1305
* 插件程序：xray-plugin_windows_amd64.exe  //需将插件https://github.com/shadowsocks/xray-plugin/releases下载解压后放至shadowsocks同目录
* 插件选项: tls;host=xxx.herokuapp.com;path=/bfa6a5b6-3f0f-430b-853a-481c56de1235-ss
```
</details>
...
* [CloudflareST](https://github.com/jamako/CloudflareST) `OpenWrt推荐-速度较快`
* [cf-autoupdate](https://github.com/jamako/cf-autoupdate) `OpenWrt推荐`
